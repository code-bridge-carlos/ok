...
export const ALLOWED_ORIGINS = new Set<string>([
  "http://localhost:8080", "http://localhost:9003", "http://localhost:9004",
  "http://localhost:9005", "https://s1-panel.onrender.com",
]);
...
export function applyCORS(headers: Headers, origin: string | null): void {
  ...
  if (o) { headers.set("Access-Control-Allow-Origin", o); headers.set("Vary", "Origin"); }
